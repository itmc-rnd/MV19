...
void psv_alarm_decoder()
{
	       ...
	       ALARM_PSV_FiO2_Mini=rspy_receive_buffer[5];
				 ...
				 char buf[50];
				 sprintf(buf, "ALARM_PSV - Fr_Maxi=%d , FiO2_Mini=%d , FiO2_Maxi=%d , Vti_Mini=%d , Vti_Maxi=%d , Vte_Mini=%d %s", ALARM_PSV_Fr_Maxi,ALARM_PSV_FiO2_Mini,ALARM_PSV_FiO2_Maxi,ALARM_PSV_Vti_Mini,ALARM_PSV_Vti_Maxi,ALARM_PSV_Vte_Mini,"\r\n");
...
void pcv_alarm_decoder()
{
	       ...
	       ALARM_PCV_FiO2_Mini=rspy_receive_buffer[5];
				 ...
				 char buf[50];
				 sprintf(buf, "ALARM_PCV - Fr_Maxi=%d , FiO2_Mini=%d , FiO2_Maxi=%d , Vti_Mini=%d , Vti_Maxi=%d , Vte_Mini=%d %s", ALARM_PCV_Fr_Maxi,ALARM_PCV_FiO2_Mini,ALARM_PCV_FiO2_Maxi,ALARM_PCV_Vti_Mini,ALARM_PCV_Vti_Maxi,ALARM_PCV_Vte_Mini,"\r\n");
				 print_debug((uint8_t *)buf, strlen(buf));
...
void acv_alarm_decoder()
{
	       ...
	       ALARM_ACV_Pi_Maxi=rspy_receive_buffer[5];
				 ...
				 char buf[50];
				 sprintf(buf, "ALARM_ACV - Fr_Maxi=%d , FiO2_Mini=%d , FiO2_Maxi=%d , Vti_Mini=%d , Vti_Maxi=%d , Vte_Mini=%d %s", ALARM_ACV_Pi_Mini,ALARM_ACV_Pi_Maxi,ALARM_ACV_Fr_Maxi,ALARM_ACV_FiO2_Mini,ALARM_ACV_FiO2_Maxi,ALARM_ACV_Vte_Mini,"\r\n");
				 print_debug((uint8_t *)buf, strlen(buf));
...
void simv_alarm_decoder()
{
	       ...
	       ALARM_SIMV_Pi_Maxi=rspy_receive_buffer[5];
				 ...
				 char buf[50];
				 sprintf(buf, "ALARM_SIMV - Fr_Maxi=%d , FiO2_Mini=%d , FiO2_Maxi=%d , Vti_Mini=%d , Vti_Maxi=%d , Vte_Mini=%d %s", ALARM_SIMV_Pi_Mini,ALARM_SIMV_Pi_Maxi,ALARM_SIMV_Fr_Maxi,ALARM_SIMV_FiO2_Mini,ALARM_SIMV_FiO2_Maxi,ALARM_SIMV_Vte_Mini,"\r\n");
				 print_debug((uint8_t *)buf, strlen(buf));
