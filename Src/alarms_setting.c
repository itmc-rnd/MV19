...
void psv_alarm_decoder()
{
	       ...
	       ALARM_PSV_FiO2_Mini=rspy_receive_buffer[5];
				 ...
				 ALARM_PSV_Vti_Mini=rspy_receive_buffer[7]*256+rspy_receive_buffer[8];
				 ALARM_PSV_Vti_Maxi=rspy_receive_buffer[9]*256+rspy_receive_buffer[10];
				 ALARM_PSV_Vte_Mini=rspy_receive_buffer[11]*256+rspy_receive_buffer[12];			   
...
void acv_alarm_decoder()
{
	       ...
	       ALARM_ACV_Pi_Maxi=rspy_receive_buffer[5];
				 ...
				 ALARM_ACV_Vte_Mini=rspy_receive_buffer[9]*256+rspy_receive_buffer[10];
...
void simv_alarm_decoder()
{
	       ...
	       ALARM_SIMV_Pi_Maxi=rspy_receive_buffer[5];
				 ...
				 ALARM_SIMV_Vte_Mini=rspy_receive_buffer[9]*256+rspy_receive_buffer[10];
